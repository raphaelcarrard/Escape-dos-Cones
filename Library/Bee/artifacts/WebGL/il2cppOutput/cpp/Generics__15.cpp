...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t Dictionary_2_EnsureCapacity_m63F00E3574CCB86681C6FCF9024C72208F4D985A_gshared (Dictionary_2_t742025C6B46C0B039082A9116508B0ADEE306CFB* __this, int32_t ___0_capacity, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_000b:
	{
		EntryU5BU5D_t11831A24A2F6F1150AE249518B08E3AEE7BB299D* L_1 = __this->____entries;
		if (!L_1)
		{
			goto IL_001d;
		}
...
IL_0025:
	...
	}
	{
		...
		int32_t L_8;
		L_8 = Dictionary_2_Initialize_mC3446B50F2BBEF3C01C35FE0BDCB295AF0FD3A15(__this, L_7, il2cpp_rgctx_method(method->klass->rgctx_data, 2));
		return L_8;
	}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m77676F9C87076E832D09EBE6CDAB13175A526016(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 45));
		int32_t L_12 = V_1;
		return L_12;
	}
}
